...
def get_location_image_backend(e):
    url = f'http://127.0.0.1:5000/get_map_image?latitude={latitude}&longitude={longitude}&zoom=15&size=600x400&markers=color:red|label:S|{latitude},{longitude}&maptype=roadmap'
